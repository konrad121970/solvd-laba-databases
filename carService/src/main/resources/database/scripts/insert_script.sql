...
insert into stocks_has_products
            (stocks_id,products_id,count)
     values (2,1,1),
            (1,2,10),
            (1,3,15),
            (1,4,15),
...
insert into employees
            (workshop_id,name,surname,phone_number,position)
     values (1,'John','Doe','123456789','Mechanic'),
...
insert into accounts
            (login,password,employees_id)
     values ('john_doe','hashed_password',1),
...
insert into roles_has_accounts
            (roles_id,accounts_id)
     values (2,1), -- Mechanic role for John Doe
...
insert into contracts
            (start_date,end_date,type,salary,active,employees_id)
     values ('2023-01-01','2024-12-31','Full-time',5000.00,1,1),
...
insert into monthly_payments
            (amount,payment_date,employees_id)
     values (5000,'2023-01-15',1),
            (5000,'2023-02-15',1),
            (5000,'2023-03-15',1),
            (5000,'2023-04-15',1),
            (5000,'2023-05-15',1),
...
insert into bonus_payments
            (amount,description,monthly_payments_id)
     values (1000.00,'Year-end bonus',12),
...
insert into vehicles
            (vin,make,model,license_plate)
     values ('1HGCM82633A654321','Toyota','Camry','MNO456'),
...
insert into customers
     ...
     values ('Michael','Johnson','michael.johnson@example.com','123456789'),
...
insert into invoices
     ...
     values ('2023-01-10 12:30:00',350.00),
...
insert into invoices_has_products
            (invoices_id,products_id)
     values (1,1), -- Invoice 1 has Flywheel
...
insert into service_orders
            (vehicles_id,customers_id,date,completed,invoices_id,workshop_id,
             employees_id,
             description)
     values (1,1,'2023-01-10',1,1,1,1,'Description for Service Order 1'),
