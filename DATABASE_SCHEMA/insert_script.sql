...
VALUES
    ...
    ('P010', 'Michelin 245/45R17', 300.00);
...
INSERT INTO service_orders (vehicles_id, customers_id, date, completed, invoices_id, workshop_id, employees_id)
VALUES
    (1, 1, '2023-01-10', 1, 1, 1, 1),
    (2, 2, '2023-02-12', 1, 2, 1, 3),
    (3, 3, '2023-03-15', 0, NULL, 1, 5),
    (4, 4, '2023-04-18', 1, 3, 1, 2),
    (5, 5, '2023-05-20', 0, NULL, 1, 4),
    (6, 6, '2023-06-22', 1, 4, 1, 1),
    (7, 7, '2023-07-25', 0, NULL, 1, 3),
    (8, 8, '2023-08-28', 1, 5, 1, 5),
    (9, 9, '2023-09-30', 0, NULL, 1, 2),
    (10, 10, '2023-10-05', 1, 6, 1, 4);
